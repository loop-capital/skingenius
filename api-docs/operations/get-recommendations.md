...
curl -X POST \
  ...
  -d '{"conditions":[{"condition_id":"fzS","confidence":0,"features":["Rez"],"name":"Post-Inflammatory Hyperpigmentation (PIH)","severity":"severe","zone":"cheek-left"}],"fitzpatrick_type":4,"price_tier":"$$$","skin_type":"oily"}'
```
