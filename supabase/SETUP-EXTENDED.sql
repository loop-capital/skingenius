...
-- ============================================
-- SEED: skin_conditions (foreign key targets)
-- ============================================
...
INSERT INTO public.skin_conditions (name, slug, category, description) VALUES
  ...
  ('Atopic Dermatitis (Eczema)', 'atopic-dermatitis', 'sensitivity', 'Dry itchy patches'),
  ...
  ('Hidradenitis Suppurativa', 'hidradenitis-suppurativa', 'acne', 'Chronic abscesses in folds'),
  ('Ingrown Hair', 'ingrown-hair', 'other', 'Hair grows into skin'),
  ('Dandruff', 'dandruff', 'other', 'Flaky scalp'),
  ('Dyshidrotic Eczema', 'dyshidrotic-eczema', 'sensitivity', 'Blisters on hands/feet'),
  ('Lupus Rash', 'lupus-rash', 'other', 'Butterfly rash from lupus'),
  ('Stretch Marks', 'stretch-marks', 'other', 'Dermal scarring'),
  ('Dark Circles', 'dark-circles', 'pigmentation', 'Under-eye discoloration'),
  ('Crows Feet', 'crows-feet', 'aging', 'Lines around eyes'),
  ('Forehead Lines', 'forehead-lines', 'aging', 'Horizontal wrinkles'),
  ('Frown Lines', 'frown-lines', 'aging', 'Vertical brow lines'),
  ('Nasolabial Folds', 'nasolabial-folds', 'aging', 'Smile lines'),
  ('Marionette Lines', 'marionette-lines', 'aging', 'Mouth-to-chin lines'),
  ('Neck Lines', 'neck-lines', 'aging', 'Horizontal neck creases'),
  ('Loss of Facial Volume', 'loss-of-facial-volume', 'aging', 'Hollowing of face'),
  ('Thinning Skin', 'thinning-skin', 'aging', 'Dermal thinning'),
  ('Enlarged Blood Vessels', 'enlarged-blood-vessels', 'redness', 'Visible veins'),
  ('Bruise Easily', 'bruise-easily', 'sensitivity', 'Easy bruising'),
  ('Skin Tags', 'skin-tags', 'other', 'Benign pedunculated growths'),
  ('Moles', 'moles', 'other', 'Melanocytic nevi'),
  ('Warts', 'warts', 'other', 'HPV-caused growths'),
  ('Herpes Simplex', 'herpes-simplex', 'other', 'HSV cold sores'),
  ('Chickenpox Scars', 'chickenpox-scars', 'scarring', 'Pitted scars from varicella'),
  ('Acne Scars', 'acne-scars', 'scarring', 'Post-acne scarring'),
  ('Birthmarks', 'birthmarks', 'other', 'Congenital skin marks')
ON CONFLICT (slug) DO UPDATE SET name = EXCLUDED.name, category = EXCLUDED.category, description = EXCLUDED.description;


-- ============================================
-- EXTENDED TABLES + ALL SEED DATA
-- ============================================
