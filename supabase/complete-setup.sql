...
CREATE TABLE IF NOT EXISTS public.root_causes (
  ...
  common_tests TEXT[] DEFAULT 'ARRAY[]',
...
CREATE TABLE IF NOT EXISTS public.supplements (
  ...
  evidence_level TEXT NOT NULL CHECK (evidence_level IN ('A', 'B', 'C', 'D')),
  benefits TEXT[] DEFAULT 'ARRAY[]',
  concerns_treated TEXT[] DEFAULT 'ARRAY[]',
  interactions TEXT[] DEFAULT 'ARRAY[]',
  pregnancy_safe TEXT,
  root_causes_targeted TEXT[] DEFAULT 'ARRAY[]',
  created_at TIMESTAMPTZ DEFAULT NOW(),
...
CREATE TABLE IF NOT EXISTS public.medications (
  ...
  skin_effects TEXT[] DEFAULT 'ARRAY[]',
  interactions TEXT[] DEFAULT 'ARRAY[]',
...
CREATE TABLE IF NOT EXISTS public.user_health_assessments (
  ...
  answers JSONB NOT NULL DEFAULT 'ARRAY[]',
  detected_root_causes TEXT[] DEFAULT 'ARRAY[]',
  detected_mechanisms TEXT[] DEFAULT 'ARRAY[]',
  confidence_scores JSONB DEFAULT 'ARRAY[]',
  severity TEXT CHECK (severity IN ('mild', 'moderate', 'severe')),
  requires_practitioner BOOLEAN DEFAULT FALSE,
  practitioner_specialty_recommended TEXT[] DEFAULT 'ARRAY[]',
...
CREATE TABLE IF NOT EXISTS public.recommendations (
  ...
  evidence_level TEXT CHECK (evidence_level IN ('A', 'B', 'C', 'D')),
  safety_notes TEXT,
  contraindications TEXT[] DEFAULT 'ARRAY[]',
  is_accepted BOOLEAN,
...
CREATE TABLE IF NOT EXISTS public.basys_referrals (
  ...
  recommended_tests TEXT[] DEFAULT 'ARRAY[]',
