...
INSERT INTO public.supplements (id, name, dosage, evidence_level, benefits, concerns_treated) VALUES
  ('zinc_picolinate_25_30mg', 'Zinc picolinate', '30mg', 'B', {'Inhibits 5-alpha reductase, anti-inflammatory; pair with copper 2-3mg', 'Modulates total androgen activity; natural anti-inflammatory; reduces lipid content of sebum. Pair with copper 2-3mg.'}, {'acne-vulgaris', 'excess-sebum-enlarged-pores'}),
  ('omega_3_(epa_dha_1000_2000mg)', 'Omega-', '2000mg', 'B', {'Anti-inflammatory; reduces PGE2 and LTB4; improves insulin sensitivity', 'Anti-inflammatory; improves insulin sensitivity; reduces prostaglandin-driven sebum production.', 'Essential fatty acids; supports barrier repair and reduces inflammation'}, {'acne-vulgaris', 'excess-sebum-enlarged-pores', 'barrier-dysfunction'}),
  ('vitamin_d3_2000_4000_iu', 'Vitamin D', '4000 IU', 'B', {'Deficiency common in acne; immune modulation; check 25(OH)D levels'}, {'acne-vulgaris'}),
  ('spearmint_tea', 'Spearmint tea', '2 cups daily showed reduction in free testosterone', 'B', {'Anti-androgen properties; 2 cups daily showed reduction in free testosterone'}, {'hormonal-acne'}),
  ('zinc_25_30mg', 'Zinc', '30mg', 'B', {'Inhibits 5-alpha reductase; reduces androgen-driven sebum'}, {'hormonal-acne'}),
  ('inositol_(myo_inositol)', 'Inositol (myo-inositol)', 'As directed', 'B', {'Improves insulin sensitivity; especially beneficial for PCOS-related acne'}, {'hormonal-acne'}),
  ('dim_(diindolylmethane)', 'DIM (diindolylmethane)', 'As directed', 'D', {'Promotes estrogen metabolism toward beneficial 2-hydroxyestrone pathway'}, {'hormonal-acne'}),
  ('zinc_15_25mg', 'Zinc', '25mg', 'B', {'Anti-inflammatory; supports healing', 'Anti-inflammatory support'}, {'acne-mechanica', 'rosacea'}),
  ('probiotics', 'Probiotics', 'As directed', 'D', {'Support microbiome balance', 'Gut-skin axis support', 'Support gut-skin axis'}, {'fungal-acne', 'rosacea', 'psoriasis', 'perioral-dermatitis', 'tinea-versicolor'}),
  ('omega_3', 'Omega-', 'As directed', 'B', {'Anti-inflammatory support', 'Anti-inflammatory; may improve skin texture'}, {'steroid-acne', 'seborrheic-dermatitis', 'keratosis-pilaris', 'razor-bumps'}),
  ('omega_3_(epa_dha)', 'Omega-', 'As directed', 'B', {'Anti-inflammatory; reduces flushing', 'Anti-inflammatory; reduces Th2 response', 'Anti-inflammatory; reduces disease severity', 'Essential fatty acids; supports barrier'}, {'rosacea', 'atopic-dermatitis', 'psoriasis', 'xerosis'}),
  ('vitamin_d3', 'Vitamin D', 'As directed', 'B', {'Deficiency common in eczema; immune modulation', 'Deficiency common; immune modulation'}, {'atopic-dermatitis', 'psoriasis'}),
  ('probiotics_(lactobacillus,_bifidobacterium)', 'Probiotics (Lactobacillus, Bifidobacterium)', 'As directed', 'B', {'Support gut and skin microbiome'}, {'atopic-dermatitis'}),
  ('quercetin', 'Quercetin', 'As directed', 'D', {'Natural mast cell stabilizer; antihistamine properties'}, {'atopic-dermatitis'}),
  ('vitamin_c', 'Vitamin C', 'As directed', 'B', {'Supports barrier repair and antioxidant defense', 'Antioxidant support', 'Antioxidant; supports melanin normalization', 'Immune support; wound healing'}, {'contact-dermatitis', 'melasma', 'post-inflammatory-hyperpigmentation', 'cold-sore'}),
  ('biotin', 'Biotin', 'As directed', 'D', {'Supports skin health'}, {'seborrheic-dermatitis'}),
  ('curcumin', 'Curcumin', 'As directed', 'B', {'Anti-inflammatory; Th17 modulation'}, {'psoriasis'}),
  ('oral_tranexamic_acid', 'Oral tranexamic acid', '250mg 2x daily', 'A', {'250mg 2x daily; prescription; significant improvement'}, {'melasma'}),
  ('polypodium_leucotomos', 'Polypodium leucotomos', 'As directed', 'B', {'Oral photoprotectant; reduces UV-induced pigmentation', 'Oral photoprotectant', 'Oral photoprotectant; may enhance repigmentation'}, {'melasma', 'solar-lentigines', 'vitiligo'}),
  ('zinc', 'Zinc', 'As directed', 'B', {'Anti-inflammatory; supports healing', 'Anti-inflammatory; immune support', 'Immune support; antiviral properties'}, {'post-inflammatory-hyperpigmentation', 'folliculitis', 'cold-sore'}),
  ('vitamin_d', 'Vitamin D', 'As directed', 'B', {'Deficiency common; immune modulation', 'Maintain adequate levels'}, {'actinic-keratosis', 'skin-cancer-melanoma'}),
  ('vitamin_e', 'Vitamin E', 'As directed', 'B', {'Antioxidant; supports barrier', 'Antioxidant; supports barrier repair'}, {'xerosis', 'barrier-dysfunction'}),
  ('hyaluronic_acid_(oral)', 'Hyaluronic acid (oral)', 'As directed', 'D', {'May improve skin hydration'}, {'xerosis'}),
  ('l_lysine', 'L-Lysine', 'As directed', 'B', {'May reduce recurrence frequency'}, {'cold-sore'}),
  ('green_tea_extract_(egcg)_400_800mg', 'Green Tea Extract (EGCG)', '800mg', 'B', {'Systemic 5-alpha reductase inhibitor; reduces DHT production from inside.'}, {'excess-sebum-enlarged-pores'}) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, dosage = EXCLUDED.dosage, evidence_level = EXCLUDED.evidence_level, benefits = EXCLUDED.benefits, concerns_treated = EXCLUDED.concerns_treated;
