-- ============================================
-- SKINgenius — RUN THIS ENTIRE FILE IN SUPABASE SQL EDITOR
-- ============================================
...
-- ============================================
-- EXTENDED TABLES + SEED DATA
-- ============================================

-- ============================================
-- SEED DATA: SKIN CONDITIONS (required for foreign keys)
-- ============================================

INSERT INTO public.skin_conditions (name, slug, category, description) VALUES
  ('Acne Vulgaris', 'acne-vulgaris', 'acne', 'Common acne characterized by comedones, papules, pustules, and cysts'),
  ('Hormonal Acne', 'hormonal-acne', 'acne', 'Acne driven by hormonal fluctuations, typically along jawline and chin'),
  ('Acne Mechanica', 'acne-mechanica', 'acne', 'Acne caused by friction, pressure, or heat from clothing/equipment'),
  ('Steroid Acne', 'steroid-acne', 'acne', 'Acne caused by corticosteroid use'),
  ('Fungal Acne', 'fungal-acne', 'acne', 'Malassezia folliculitis — yeast-driven breakouts, often itchy'),
  ('Excess Sebum & Enlarged Pores', 'excess-sebum-enlarged-pores', 'acne', 'Overproduction of sebum leading to visibly enlarged pores'),
  ('Rosacea', 'rosacea', 'redness', 'Chronic facial redness, visible blood vessels, and sometimes bumps'),
  ('Perioral Dermatitis', 'perioral-dermatitis', 'redness', 'Red, bumpy rash around the mouth, nose, and eyes'),
  ('Psoriasis', 'psoriasis', 'other', 'Autoimmune condition causing scaly, inflamed patches'),
  ('Atopic Dermatitis (Eczema)', 'atopic-dermatitis', 'sensitivity', 'Chronic inflammatory skin condition causing dry, itchy patches'),
  ('Contact Dermatitis', 'contact-dermatitis', 'sensitivity', 'Inflammatory reaction from direct contact with irritants or allergens'),
  ('Seborrheic Dermatitis', 'seborrheic-dermatitis', 'other', 'Flaky, scaly skin on oily areas like scalp, face, and chest'),
  ('Melasma', 'melasma', 'pigmentation', 'Brown or gray patches, often on face, triggered by sun and hormones'),
  ('Post-Inflammatory Hyperpigmentation', 'post-inflammatory-hyperpigmentation', 'pigmentation', 'Dark spots left after skin inflammation or injury heals'),
  ('Solar Lentigines', 'solar-lentigines', 'pigmentation', 'Age spots or liver spots caused by sun exposure'),
  ('Vitiligo', 'vitiligo', 'pigmentation', 'Loss of skin pigment causing white patches'),
  ('Actinic Keratosis', 'actinic-keratosis', 'sun_damage', 'Rough, scaly patches from years of sun exposure — precancerous'),
  ('Seborrheic Keratosis', 'seborrheic-keratosis', 'other', 'Common benign skin growth, brown/black, waxy appearance'),
  ('Folliculitis', 'folliculitis', 'acne', 'Inflammation of hair follicles, often from bacteria or yeast'),
  ('Keratosis Pilaris', 'keratosis-pilaris', 'texture', 'Small rough bumps caused by keratin buildup in hair follicles'),
  ('Cold Sore (HSV-1)', 'cold-sore', 'other', 'Viral blister outbreak, usually on or around lips'),
  ('Razor Bumps (Pseudofolliculitis Barbae)', 'razor-bumps', 'other', 'In-grown hairs causing bumps, common in curly/coily hair types'),
  ('Tinea Versicolor', 'tinea-versicolor', 'other', 'Yeast infection causing discolored patches on skin'),
  ('Barrier Dysfunction', 'barrier-dysfunction', 'sensitivity', 'Compromised skin barrier leading to dryness, irritation, and sensitivity'),
